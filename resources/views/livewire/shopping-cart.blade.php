    ...
    <div class="grid grid-cols-1 lg:grid-cols-7 gap-6">
        <div class="lg:col-span-5">
            <div class="flex justify-between mb-2">
                ...
                <button class="font-semibold text-gray-600 underline hover:no-underline hover:text-purple-500" wire:click="destroy">Limpiar
                    Carro</button>
            </div>
            ...
            <div class="card">
                <ul class="space-y-4">
                    @forelse (Cart::content() as $item)
                        <li class="lg:flex ">
                            <img class="w-full lg:w-36 aspect-square object-cover object-center mr-3"
        ...
        <div class="lg:col-span-2 mt-8">
                <div class="card">
                    ...
                    <a href="{{route('shipping.index')}}" class="btn btn-purple block w-full text-center">Continuar Compra</a>
                </div>
        </div>
    </div>
</div>
